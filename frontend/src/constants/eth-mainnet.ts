export const ETH_MAINNET_CRYPTO_ITEMS = [
  {
    id: "INCH / ETH",
    title: "1inch",
    type: "Crypto",
...
export const ETH_MAINNET_COMMODITIES_ITEMS = [
  {
    id: "WTI / USD",
    title: "WTI Crude",
    type: "Commodities",
...
export const ETH_MAINNET_FOREX_ITEMS = [
  {
    id: "AUD / USD",
...
export const ETH_MAINNET_EQUITIES_ITEMS = [
  {
    id: "AAPL / USD",
    title: "Apple",
    type: "Equities",
